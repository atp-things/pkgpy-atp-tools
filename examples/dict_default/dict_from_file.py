...
# def_dict.from_file(Path("data_sample", "dict_test", "test1.yaml"))
# def_dict.from_file(Path("data_sample", "dict_test", "test1.yml"))
# def_dict.from_file(Path("data_sample", "dict_test", "test1.toml"))
